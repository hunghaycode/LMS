@php
    $teams = App\Models\User::where(['status'=> 1,'role'=> 'instructor'])->orderBy('id', 'ASC')->limit(6)->get();
                    ...
                    <div class="ourinstructor-active">
                        ...
                        <div class="mentor">
                            <div class="mentor__img">
                                <img src=" {{ (!empty($team->photo)) ? url($team->photo) : url('upload/no_image.jpg')}}" alt="Mentor
                                    image" />
                            ...
                            <div class="mentor__title">
                                <h6>
                                    <a href="instructor-profile.html" tabindex="0">{{$team->name }}</a>
                                </h6>
                                <p>{{$team->username}}</p>
                            </div>
                        </div>
