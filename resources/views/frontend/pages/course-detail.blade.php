        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#" class="fs-6 text-secondary">{{ $courseDetail['category']['category_name'] }}</a>
                    </li>

                    <li class="breadcrumb-item fs-6 text-secondary d-none d-lg-inline-block" aria-current="page">
                        {{-- {{ $courseDetail['sub_category']['sub_category_name'] }} --}}
                        {{ $courseDetail->subcategory->sub_category_name }}
                    </li>
            ...
            <div class="row event-sub-section-main">
                <div class="col-lg-8">
                    ...
                    <h5 class="mt-2"> {{ $courseDetail->course_title }}</h5>
                    <p class="font-para--md"> Last updated {{ $courseDetail->created_at->format('M d Y') }}</p>

                    <div class="created-by d-flex align-items-center">
                        <div class="me-3">
                            <img src="{{ asset($courseDetail->user->photo) }}" alt=""
                        ...
                        <div class="created-by-text">
                            <p>Created by</p>
                            <h6><a
                                    href="{{ route('instructor.details', $courseDetail->instructor_id) }}">{{ $courseDetail->user->name }}</a>
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="course-overview">
                        <div class="course-overview-image">
                            <img src="{{ asset($courseDetail->course_image) }}" alt="img" />
                            <a class="popup-video play-button" href="{{ asset($courseDetail->video) }}">
                        ...
                        <div class="tab-content course-overview-content" id="pills-tabContentTwo">
                            <div class="tab-pane fade show active" id="pills-courseoverview" role="tabpanel"
                                ...
                                <div class="row course-overview-main mt-4">
                                    <div class="course-overview-main-item">
                                        <h6 class="font-title--card">Course Goals</h6>
                            ...
                            <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                ...
                                @php
                                    $lecture = App\Models\CourseLecture::where('course_id', $courseDetail->id)->get();
                                @endphp
                                <div class="row">
                                    <div class="course-curriculum-area">
                                        @php
                                            $section = App\Models\CourseSection::where('course_id', $courseDetail->id)
                                                ->orderBy('id', 'asc')
                                                ->get();
                                        ...
                                        @foreach ($section as $sec)
                                            ...
                                            <div class="curriculum-area">
                                                ...
                                                <div class="curriculum-area-top {{ $loop->index >= 1 ? 'collapsed' : '' }}"
                                                    role="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse-{{ $sec->id }}" aria-expanded="false"
                                                    ...
                                                    <div class="curriculum-area-top-start">
                                                        ...
                                                        <p class="font-para--lg"> {{ $sec->section_title }}</p>
                                                    </div>
                                                        ...
                                                        <div class="total-hours">
                                                            <svg width="18" height="19" viewBox="0 0 18 19"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M9 5V9.5L12 11" stroke="#FFC91B"
                                                ...
                                                <div class="curriculum-area-bottom collapse {{ $loop->index == 0 ? 'show' : '' }}"
                                                    id="collapse-{{ $sec->id }}">
                                        ...
                                        <div class="course-instructor">
                                            <div class="course-instructor-info">
                                                <div class="instructor-image">
                                                    <img src="{{ asset($courseDetail->user->photo) }}"
                                                        alt="Instructor" />
                                                </div>
                                                <div class="instructor-text">
                                                    ...
                                                    <div class="d-flex align-items-center instructor-text-bottom">
                                                        ...
                                                        <div class="d-flex align-items-center ratings-icon">
                                                            ...
                                                            <p class="font-para--md">{{ count($instructorCourses) }}
                                                                Courses</p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="pills-courses" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                <div class="course">
                                                    <div class="course__img">
                                                        <a href="#"><img src="dist/images/courses/demo-img-01.png"
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="course">
                                                    <div class="course__img">
                                                        <a href="#"><img src="dist/images/courses/demo-img-02.png"
                                                                alt="images" class="img-fluid" /></a>
                                                    </div>
                                                    <div class="course__content">
                                                        <div class="course__content_title">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="course">
                                                    <div class="course__img">
                                                        <a href="#"><img src="dist/images/courses/demo-img-05.png"
                                                                alt="images" class="img-fluid" /></a>
                                                    </div>
                                                    <div class="course__content">
                                                        <div class="course__content_title">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="course">
                                                    <div class="course__img">
                                                        <a href="#"><img src="dist/images/courses/demo-img-03.png"
                                                                alt="images" class="img-fluid" /></a>
                                                    </div>
                                                    <div class="course__content">
                                                        <div class="course__content_title">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="course">
                                                    <div class="course__img">
                                                        <a href="#"><img src="dist/images/courses/8.jpg"
                                                                alt="images" class="img-fluid" /></a>
                                                    </div>
                                                    <div class="course__content">
                                                        <div class="course__content_title">
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="course">
                                                    <div class="course__img">
                                                        <a href="#"><img src="dist/images/courses/demo-img-04.png"
                                                                alt="images" class="img-fluid" /></a>
                                                    </div>
                                                    <div class="course__content">
                                                        <div class="course__content_title">
                                                    ...
                                                    <div class="students-feedback-item">
                                                        <div class="feedback-rating">
                                                            <div class="feedback-rating-start">
                                                                <div class="image">
                                                                    <img src="dist/images/ellipse/user.jpg"
                                                                        alt="Image" />
                                                                </div>
                                                                <div class="text">
                                                        ...
                                                        <p class="font-para--md">
                                                            ...
                                                            tempor, vestibulum ante non, vulputate nibh. Cras non molestie
                        ...
                        <div class="cart">
                            <div class="cart__price">
                                <div class="current-price">
                                    <h3 class="font-title--sm">${{ $courseDetail->discount_price }}</h3>
                                    <p><del>${{ $courseDetail->selling_price }}</del></p>
                                </div>
                                @php
                                    $amount = $courseDetail->selling_price - $courseDetail->discount_price;
                                    $discount = ($amount / $courseDetail->selling_price) * 100;
                                @endphp
                                <div class="current-discount">
                                    <p class="font-para--md">{{ round($discount) }}% off</p>
                                </div>
                            </div>
                            <div class="cart__checkout-process">
                                ...
                                <form action="#" onsubmit="return false;">
                                    <button type="submit"
                                        onclick="addToCart({{ $courseDetail->id }}, '{{ $courseDetail->course_name }}', '{{ $courseDetail->instructor_id }}', '{{ $courseDetail->course_name_slug }}' )"
                                        class="button button-lg button--primary w-100">
                                        Add to Cart
                                    </button>
                                    <button
                                        onclick="buyCourse({{ $courseDetail->id }}, '{{ $courseDetail->course_name }}', '{{ $courseDetail->instructor_id }}', '{{ $courseDetail->course_name_slug }}' )"
                                        type="submit" class="button button-lg button--primary-outline mt-3 w-100">
                                        Buy Now
                                    </button>
                                <div class="mt-4">
                                    <label for="coupon">Apply Coupon <span class="badged-blue"
                                        id="coupon-sc">Nhập
                                        Coupon</span></label>
                                <div class="cart-input" id="couponField">
                                    <input type="text" id="coupon_name"
                                        class="form-control" placeholder="Coupon Code" />
                                        <input type="hidden" id="course_id" name="course_id" value="{{ $courseDetail->id }}">
                                        <input type="hidden" id="instrutor_id" name="instrutor_id" value="{{ $courseDetail->instructor_id }}">
                                    <button type="submit" onclick="applyInsCoupon()"
                                        class="button button-lg button--primary-outline mt-3 w-100">Apply</button>
                                </div>
                                </div>
                                </form>
    ...
    <section class="section new-course-feature section--bg-offwhite-five">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <h4 class="font-title--md ">Instructor's course <div class="text-primary">
                            {{ $courseDetail->user->name }}</div>
                    </h4>
                </div>
                <div class="row">
                            ...
                            @foreach ($instructorCourses as $inscourse)
                                ...
                                <div class="contentCard contentCard--course contentCard--space">
                                    <div class="contentCard-top">
                                        <a
                                            href="{{ url('course/details/' . $inscourse->id . '/' . $inscourse->course_name_slug) }}"><img
                                                src="{{ asset($inscourse->course_image) }}" alt="images"
                                                class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div>
                                                ...
                                                @endif
                                                <span class="badged-orange"> {{ $inscourse->label }}</span>
                                            </div>
                                            ...
                                            <div class="ml-auto">
                                                ...
                                                <button type="submit" class="btn btn-outline-primary btn-sm"
                                                    id="button-addon2"
                                                    onclick="addToCart({{ $inscourse->id }}, '{{ $inscourse->course_name }}', '{{ $inscourse->instructor_id }}', '{{ $inscourse->course_name_slug }}' )">Add
                                                    cart</button>
                                            </div>
                                        </div>
                                        <h5>
                                            <a href="{{ url('course/details/' . $inscourse->id . '/' . $inscourse->course_name_slug) }}"
                                                class="font-title--card">{{ $inscourse->course_name }}</a>
                                        </h5>
                                        <div class="contentCard-info d-flex align-items-center justify-content-between">
                                            <a href="{{ route('instructor.details', $courseDetail->instructor_id) }}"
                                                class="contentCard-user d-flex align-items-center">
                                                <img src="{{ asset($inscourse->user->photo) }}" alt="client-image"
                                                    class="img-fluid rounded-circle"
                                                    style="width: 50px; height: 50px;object-fit: cover" />
                                                <p class="font-para--md">{{ $inscourse['user']['name'] }}</p>
                                            </a>

                                            <div class="price">
                                                @if ($inscourse->discount_price !== null)
                                                    <span>${{ $inscourse->discount_price }}</span>
                                                    <del>${{ $inscourse->selling_price }}</del>
                                                @else
                                                    <span>${{ $inscourse->selling_price }}</span>
                                                @endif
                                            </div>
                                        ...
                                        <div class="contentCard-more">
                                            ...
                                            <div class="clock d-flex align-items-center">
                                                ...
                                                <span>{{ $inscourse->duration }} Hours</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <h4 class="font-title--md ">Related Courses </h4>
                </div>
                <div class="row">
                    <div class="col-12 position-relative px-0 mx-0">
                        <div class="new__courses">
                            ...
                            @foreach ($relatedCourses as $related)
                                ...
                                <div class="contentCard contentCard--course contentCard--space">
                                    <div class="contentCard-top">
                                        <a
                                            href="{{ url('course/details/' . $related->id . '/' . $related->course_name_slug) }}"><img
                                                src="{{ asset($related->course_image) }}" alt="images"
                                                class="img-fluid" /></a>
                                    </div>
                                    <div class="contentCard-bottom">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div>
                                                @if ($related->bestseller == 1)
                                                    <span class="badged">Bestseller</span>
                                                @endif
                                                @if ($related->highestrated == 1)
                                                    <span class="badged">Highest Rated</span>
                                                @endif
                                                ...
                                                @else
                                                    <div class="badged-blue">{{ round($discount) }}%</div>
                                                @endif
                                                <span class="badged-orange"> {{ $related->label }}</span>
                                            </div>
                                            ...
                                            <div class="ml-auto">
                                                ...
                                                <button type="submit" class="btn btn-outline-primary btn-sm"
                                                    id="button-addon2"
                                                    onclick="addToCart({{ $related->id }}, '{{ $related->course_name }}', '{{ $related->instructor_id }}', '{{ $related->course_name_slug }}' )">Add
                                                    cart</button>
                                            </div>
                                        </div>
                                        <h5>
                                            <a href="{{ url('course/details/' . $related->id . '/' . $related->course_name_slug) }}"
                                                class="font-title--card">{{ $related->course_name }}</a>
                                        </h5>
                                        <div class="contentCard-info d-flex align-items-center justify-content-between">
                                            <a href="{{ route('instructor.details', $courseDetail->instructor_id) }}"
                                                class="contentCard-user d-flex align-items-center">
                                                <img src="{{ asset($related->user->photo) }}" alt="client-image"
                                                    class="img-fluid rounded-circle"
                                                    style="width: 50px; height: 50px;" />
                                                <p class="font-para--md">{{ $related['user']['name'] }}</p>
                                            </a>

                                            <div class="price">
                                                @if ($related->discount_price !== null)
                                                    <span>${{ $related->discount_price }}</span>
                                                    <del>${{ $related->selling_price }}</del>
                                                @else
                                                    <span>${{ $related->selling_price }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="contentCard-more">
                                            ...
                                            <div class="clock d-flex align-items-center">
                                                ...
                                                <span>{{ $related->duration }} Hours</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
