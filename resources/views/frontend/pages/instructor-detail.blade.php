            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item d-none d-lg-inline-block"><a href="#"
                            class="fs-6 text-secondary">{{ $instructor->name }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="instructor-courses-instructor">
                        <div class="instructor-image mx-auto text-center">
                            <img src="{{ !empty($instructor->photo) ? url($instructor->photo) : url('upload/no_image.jpg') }}"
                                alt="Instructor" />
                        </div>
                        <div class="instructor-info text-center">
                            <h5 class="font-title--sm">{{ $instructor->name }}</h5>
                            <p class="text-secondary mb-3">
                                {{ Carbon\Carbon::parse($instructor->created_at)->diffForHumans() }}</p>
                                                ...
                                                <div class="contentCard-bottom">
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="{{ route('instructor.details', $course->instructor_id) }}"
                                                            ...
                                                            <img src="{{ asset( $course->user->photo) }}"
