        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center bg-transparent p-0 mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="course-search.html" class="fs-6 text-secondary">{{ $category->category_name }}</a>
                    </li>
                </ol>
            </nav>
        </div>
                                    ...
                                    <form action="#">
                                        ...
                                        @foreach ($categories as $cat)
                                            <div class="accordion-body__item">
                                                <div class="check-box">
                                                    <input type="checkbox" class="checkbox-primary" />
                                                    <a href="{{ url('category/' . $cat->id . '/' . $cat->category_slug) }}"><label>
                                                            {{ $cat->category_name }} </label></a>
                                                </div>
                                                <p class="check-details">
                                                    45,770
                                                </p>
                                    ...
                                    <div class="contentCard-bottom">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="d-flex ml-auto">
                                                ...
                                                <button class="btn btn-outline-primary btn-sm" type="submit" id="button-addon2"  onclick="addToCart({{ $course->id }}, '{{ $course->course_name }}', '{{ $course->instructor_id }}', '{{ $course->course_name_slug }}' )">Add cart</button>
                                            </div>
                                        ...
                                        <h5>
                                            <a href="{{ url('course/details/' . $course->id . '/' . $course->course_name_slug) }}"
                                                class="font-title--card">{{ $course->course_name }}</a>
                                        </h5>
                                        <div class="contentCard-info d-flex align-items-center justify-content-between">
                                            <a href="{{ route('instructor.details', $course->instructor_id) }}"
                                                class="contentCard-user d-flex align-items-center">
                                                <img src="{{ asset('upload/instructor_images/' . $course->user->photo) }}"
