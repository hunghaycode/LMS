                    ...
                    <div class="signup-area-textwrapper">
                        ...
                        <form method="POST" action="{{ route('login') }}">
							...
							<div class="form-element {{ $errors->has('password') ? 'error' : (old('password') ? 'active' : '') }}">
								...
								<div class="form-alert-input">
									<input type="password" name="password" placeholder="Type here..." id="password"
										oninput="this.parentNode.parentNode.classList.add('active');" />
						...
						@enderror
                            ...
                            <div class="form-element d-flex align-items-center terms">
                                <input id="remember_me" name="remember" class="checkbox-primary me-1" type="checkbox" />
                                <label for="remember_me" class="text-secondary mb-0 fs-6">Remember me</label>
                            </div>
