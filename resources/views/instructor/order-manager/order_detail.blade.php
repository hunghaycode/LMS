                        ...
                        <div class="pd-20 card-box height-100-p">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('instructor.pending-confirm', $payment->id) }}" class="badge bg-warning badge-pill">Pending Order</a>
                                @elseif ($payment->status == 'completed')
                                    <a href="{{ route('instructor.pending-confirm', $payment->id) }}" class="badge bg-success badge-pill">Confirm Order</a>
                                @endif
