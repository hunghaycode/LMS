...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('backend/asset/vendors/images/favicon-32x32.png') }}" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('backend/asset/vendors/images/favicon-16x16.png') }}" />
...
<script src="{{ asset('backend/asset/vendors/scripts/advanced-components.js')}}"></script>
    ...
    {{-- <script>
        ...
        <script>
            $(function() {
                $(document).on('click', '[id^="delete-section-"]', function(e) {
            e.preventDefault();
            var formId = $(this).attr('id').replace('delete-section-', 'delete-form-');
            var form = $('#' + formId);
