                    ...
                    <form action="{{ route('instructor.course.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="course_title"
                                    placeholder="Enter Course Title" value="{{ old('course_title') }}" required />
                                @error('course_title')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                ...
                                <input class="form-control" type="file" name="video" accept="video/mp4, video/webm"  placeholder="Enter Video URL"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <textarea class="form-control" name="resources" placeholder="Enter Resources" rows="3">{{ old('resources') }}</textarea>
                                @error('resources')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="html-editor pd-20 card-box mb-30">
                            ...
                            <textarea name="prerequisites" class="textarea_editor form-control border-radius-0" placeholder="Enter text ...">{{ old('prerequisites') }}</textarea>
                            @error('prerequisites')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="html-editor pd-20 card-box mb-30">
                            ...
                            <textarea class="form-control textarea_editor border-radius-0" name="description"
                                placeholder="Enter Course Description" rows="4">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="html-editor pd-20 card-box mb-30">
                            <h4 class="h4 text-blue">Duration</h4>

                            <input type="text" name="duration" class="form-control" id="input1" value="{{ old('duration') }}" >
                            @error('duration')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="bestseller" value="1"
                                        {{ old('bestseller') ? 'checked' : '' }} id="bestseller">
                            ...
                            <div class="col-sm-12 col-md-3">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="highest_rated" value="1"
                                        {{ old('highest_rated') ? 'checked' : '' }} id="highest_rated">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <img id="showImage"
                                    src="{{ !empty($profileInfo->photo) ? url('upload/admin_images/' . $profileInfo->photo) : url('vendors/images/photo1.jpg') }}"
                                    alt="Admin" width="120">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 col-md-10 add_item">
                                <div class="input-group mb-2" id="whole_extra_item_add">
                                    <input type="text" class="form-control col-8" name="course_goals[]"
                                        placeholder="Enter Additional Resource" required>
            ...
            $(document).ready(function() {
                $(".addeventmore").click(function() {
                    ...
                    $("#whole_extra_item_delete").append(
                        ...
                        newField +
                        '<button class="btn btn-outline-danger removeeventmore" type="button">Remove</button></div>'
                        );
                });
