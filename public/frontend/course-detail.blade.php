...
<style>
            ...
            <div class="row event-sub-section-main">
                <div class="col-lg-8">
                    ...
                    <div class="created-by d-flex align-items-center">
                        <div class="me-3">
                            <img src="{{ asset('upload/instructor_images/' . $courseDetail->user->photo) }}" alt=""
                                class="img-fluid rounded-circle" style="width: 70px; height: 70px;" />

                        </div>
                        <div class="created-by-text">
                            <p>Created by</p>
                            <h6><a href="instructor-profile.html">{{ $courseDetail->user->name }}</a></h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                                        ...
                                        <div class="curriculum-area">
                                            ...
                                            @foreach ($section as $sec)
                                                ...
                                                <div class="curriculum-area-top collapsed" role="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapse-{{ $sec->id }}"
                                                    aria-expanded="false" aria-controls="collapse-{{ $sec->id }}">
                                                ...
                                                <div class="curriculum-area-bottom collapse" id="collapse-{{ $sec->id }}">
                                            ...
                                            <div class="course-instructor-info">
                                                ...
                                                <div class="instructor-text">
                                                    <h6 class="font-title--xs mb-0">
                                                        <a href="instructor-profile.html">{{ $courseDetail['user']['name'] }}</a>
                                                    </h6>
                                                    ...
                                                    <div class="d-flex align-items-center instructor-text-bottom">
                                                        ...
                                                        <div class="d-flex align-items-center ratings-icon">
                                                            ...
                                                            <p class="font-para--md">{{ count($instructorCourses) }} Courses</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <section class="section new-course-feature section--bg-offwhite-five">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <h4 class="font-title--md ">Instructor's course <div class="text-primary">{{$courseDetail->user->name}}</div> </h4>
                </div>
                <div class="row">
                        ...
                        @endphp
                            <div class="contentCard contentCard--course contentCard--space">
                                <div class="contentCard-top">
                                    <a href="{{ url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug) }}"><img src="{{ asset($inscourse->course_image) }}" alt="images" class="img-fluid" /></a>
                                </div>
                                ...
                                <span class="badged-orange"> {{ $inscourse->label }}</span>
                                    ...
                                    <h5>
                                        <a href="{{ url('course/details/'.$inscourse->id.'/'.$inscourse->course_name_slug) }}" class="font-title--card">{{ $inscourse->course_name }}</a>
                                    </h5>
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        <a href="instructor-profile.html" class="contentCard-user d-flex align-items-center">
                                            <img src="{{asset('upload/instructor_images/' . $inscourse->user->photo)}}" alt="client-image" class="img-fluid rounded-circle" style="width: 50px; height: 50px;" />
        ...
        <div class="new-course-overlay">
            ...
            <img src="{{asset("frontend/dist/images/shape/dots/dots-img-15.png")}}" alt="shape" class="img-fluid shape02" />
        </div>
    </section>
    ...
    <section class="section new-course-feature section--bg-offwhite-five">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <h4 class="font-title--md ">Related Courses  <div class="text-primary">{{$courseDetail->user->name}}</div> </h4>
                </div>
                <div class="row">
                    <div class="col-12 position-relative px-0 mx-0">
                        <div class="new__courses">
